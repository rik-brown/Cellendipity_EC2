...
class Cell {
  ...
  strokeAlpha = map(dna.genes[7], 0, 255, 0, 255);
  }
...
class Parameters {
  ...
  Parameters() {
    ...
    strainSize = PApplet.parseInt(random(3,25)); // Number of cells in a strain
    numStrains = PApplet.parseInt(random(1,5)); // Number of strains (a group of cells sharing the same DNA)
    stepSize = 0;
    stepSizeN = 50;
